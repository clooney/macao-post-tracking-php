# Macao Post Tracking API For PHP
Macao Post Tracking API and webhook make it easy to integrate Macao Post Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a Macao Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Macao Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Macao Post Tracking API](https://www.trackingmore.com/macao-post-tracking.html)  to:

   *   Get Macao Post realtime tracking info of muti-carriers in one integration
   *   Provide Macao Post shipment tracking experience like Amazon
   *   Push Macao Post notifications of package update with webhook
   *   Verify Macao Post delivery exception before it is too late
